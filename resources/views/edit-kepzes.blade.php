<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-md sm:rounded-lg p-6 border border-gray-200 dark:border-gray-600 mt-6">
                ...
                <form action="/edit-kepzes/{{ $kepzes->id }}" method="POST" class="space-y-5 mx-2">
                    ...
                    <div>
                        ...
                        <input type="text" id="nev" name="nev" value="{{ $kepzes->nev }}"
                               class="w-full rounded-md bg-white dark:bg-gray-700 dark:text-white border-gray-300 dark:border-gray-700 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 transition" />
                    </div>
                    ...
                    <div class="flex justify-end items-center space-x-3 pt-4">
                        <a href="{{ route('kepzesek') }}"
                           class="inline-flex items-center bg-gray-200 hover:bg-gray-300 text-gray-700 dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-gray-300 font-medium px-4 py-2 rounded-md transition">
